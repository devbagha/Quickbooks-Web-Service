...
// Copyright () 2021-2022 Intuit, Inc
//
...
namespace WCWebService
{
	...
	public class WCWebService : System.Web.Services.WebService
	{
		...
		public string[] authenticate(string strUserName, string strPassword)
		{
			...
			if (strUserName.Trim().Equals("username") && strPassword.Trim().Equals(pwd))
			{
                ...
                string connectionString = @"Server=DESKTOP-1P9UPO3\SQLEXPRESS;Database=xyz;Integrated Security=True;";

                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    connection.Open();

                    // SQL command to delete all existing records
        ...
        static void SaveResponseToDatabase(string response)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // SQL command to insert the response into the testdb table
                string sql = "INSERT INTO testdb (xml) VALUES (@response)";

                using (SqlCommand command = new SqlCommand(sql, connection))
                {
                    // Add the response parameter
		...
		public ArrayList buildRequest() {
            ...
            VendorQueryRq.SetAttribute("requestID", "4");
            ...
            ItemInventoryQueryRq.SetAttribute("requestID", "5");
            ...
            ItemQueryRq.SetAttribute("requestID", "6");
            ...
            qbXML.AppendChild(qbXMLMsgsRq);
            qbXMLMsgsRq.SetAttribute("onError", "stopOnError");
            XmlElement JournalEntryQueryRq = inputXMLDoc.CreateElement("JournalEntryQueryRq");
            qbXMLMsgsRq.AppendChild(JournalEntryQueryRq);
            JournalEntryQueryRq.SetAttribute("requestID", "7");
            ...
            PurchaseOrderQueryRq.SetAttribute("requestID", "8");
            ...
            SalesOrderQueryRq.SetAttribute("requestID", "9");
            ...
            ClassQueryRq.SetAttribute("requestID", "10");
            ...
            CompanyQueryRq.SetAttribute("requestID", "11");
            ...
            qbXML.AppendChild(qbXMLMsgsRq);
            qbXMLMsgsRq.SetAttribute("onError", "stopOnError");
            XmlElement DepositQueryRq = inputXMLDoc.CreateElement("DepositQueryRq");
            qbXMLMsgsRq.AppendChild(DepositQueryRq);
            DepositQueryRq.SetAttribute("requestID", "12");
            ...
            qbXML.AppendChild(qbXMLMsgsRq);
            qbXMLMsgsRq.SetAttribute("onError", "stopOnError");
            XmlElement ItemGroupQueryRs = inputXMLDoc.CreateElement("ItemGroupQueryRq");
            qbXMLMsgsRq.AppendChild(ItemGroupQueryRs);
            ItemGroupQueryRs.SetAttribute("requestID", "13");
            ...
            EmployeeQueryRq.SetAttribute("requestID", "14");
            ...
            ReceivePaymentQueryRq.SetAttribute("requestID", "15");
            ...
            AccountQueryRq.SetAttribute("requestID", "16");
            ...
            qbXML.AppendChild(qbXMLMsgsRq);
            qbXMLMsgsRq.SetAttribute("onError", "stopOnError");
            XmlElement VendorCreditQueryRq = inputXMLDoc.CreateElement("VendorCreditQueryRq");
            qbXMLMsgsRq.AppendChild(VendorCreditQueryRq);
            VendorCreditQueryRq.SetAttribute("requestID", "17");
            ...
            qbXML.AppendChild(qbXMLMsgsRq);
            qbXMLMsgsRq.SetAttribute("onError", "stopOnError");
            XmlElement ItemInventoryAssemblyQueryRq = inputXMLDoc.CreateElement("ItemInventoryAssemblyQueryRq");
            qbXMLMsgsRq.AppendChild(ItemInventoryAssemblyQueryRq);
            ItemInventoryAssemblyQueryRq.SetAttribute("requestID", "18");
            ...
            SalesReceiptQueryRq.SetAttribute("requestID", "19");
            ...
            GeneralSummaryReportType.InnerText = "SalesByItemSummary";
            GeneralSummaryReportQueryRq.AppendChild(GeneralSummaryReportType);
            GeneralSummaryReportQueryRq.SetAttribute("requestID", "20");
            strRequestXML = inputXMLDoc.OuterXml;
            ...
            XmlElement GeneralSummaryReportQueryRqaaa = inputXMLDoc.CreateElement("GeneralDetailReportQueryRq");
            qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRqaaa);
            XmlElement GeneralSummaryReportTypeaaa = inputXMLDoc.CreateElement("GeneralDetailReportType");
            GeneralSummaryReportTypeaaa.InnerText = "CheckDetail";
            GeneralSummaryReportQueryRqaaa.SetAttribute("requestID", "24");
            GeneralSummaryReportQueryRqaaa.AppendChild(GeneralSummaryReportTypeaaa);
            ...
            XmlElement GeneralSummaryReportQueryRqaaaa = inputXMLDoc.CreateElement("GeneralDetailReportQueryRq");
            qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRqaaaa);
            XmlElement GeneralSummaryReportTypeaaaa = inputXMLDoc.CreateElement("GeneralDetailReportType");
            GeneralSummaryReportTypeaaaa.InnerText = "DepositDetail";
            GeneralSummaryReportQueryRqaaaa.SetAttribute("requestID", "25");
            GeneralSummaryReportQueryRqaaaa.AppendChild(GeneralSummaryReportTypeaaaa);
            ...
            XmlElement GeneralSummaryReportQueryRaqa = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
            qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRaqa);
            XmlElement GeneralSummaryReportTypaea = inputXMLDoc.CreateElement("GeneralSummaryReportType");
            GeneralSummaryReportTypaea.InnerText = "IncomeByCustomerSummary";
            GeneralSummaryReportQueryRaqa.SetAttribute("requestID", "26");

            GeneralSummaryReportQueryRaqa.AppendChild(GeneralSummaryReportTypaea);
            ...
            XmlElement GeneralDetailReportQueryRq = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
            qbXMLMsgsRq.AppendChild(GeneralDetailReportQueryRq);

            XmlElement GeneralDetailReportType = inputXMLDoc.CreateElement("GeneralSummaryReportType");
            GeneralDetailReportType.InnerText = "InventoryValuationSummary";
            GeneralDetailReportQueryRq.AppendChild(GeneralDetailReportType);

            XmlElement ReportDateMacro = inputXMLDoc.CreateElement("ReportDateMacro");
            ReportDateMacro.InnerText = "All";
            GeneralDetailReportQueryRq.AppendChild(ReportDateMacro);

            GeneralDetailReportQueryRq.SetAttribute("requestID", "2898");
            ...
            XmlElement ItemQueryRqs = inputXMLDoc.CreateElement("CreditMemoQueryRq");
            qbXMLMsgsRq.AppendChild(ItemQueryRqs);
            ItemQueryRqs.SetAttribute("requestID", "200");
            ...
            string[] reportDateMacros = new string[]
            {
    ...
    "LastQuarterToDate", "LastYear", "LastYearToDate"
            };

            int requestIdCounter = 1000; // Starting point for request IDs

            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement generalDetailReportType = inputXMLDoc.CreateElement("GeneralDetailReportType");
                generalDetailReportType.InnerText = "ProfitAndLossDetail";
                generalDetailReportQueryRq.AppendChild(generalDetailReportType);

                XmlElement reportDateMacro = inputXMLDoc.CreateElement("ReportDateMacro");
                reportDateMacro.InnerText = macro;
                generalDetailReportQueryRq.AppendChild(reportDateMacro);

                // Set a unique requestID for each iteration
                generalDetailReportQueryRq.SetAttribute("requestID", requestIdCounter.ToString());
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement AgingReportQueryRq = inputXMLDoc.CreateElement("AgingReportQueryRq");
                qbXMLMsgsRq.AppendChild(AgingReportQueryRq);
                XmlElement AgingReportTypes = inputXMLDoc.CreateElement("AgingReportType");
                XmlElement GeneralSummaryReportTypeasaaass = inputXMLDoc.CreateElement("ReportDateMacro");
                GeneralSummaryReportTypeasaaass.InnerText = macro;
                AgingReportTypes.InnerText = "APAgingSummary";
                AgingReportQueryRq.SetAttribute("requestID", requestIdCounter.ToString());
                AgingReportQueryRq.AppendChild(AgingReportTypes);
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement AgingReportQueryRqs = inputXMLDoc.CreateElement("AgingReportQueryRq");
                qbXMLMsgsRq.AppendChild(AgingReportQueryRqs);
                XmlElement AgingReportTypess = inputXMLDoc.CreateElement("AgingReportType");
                XmlElement GeneralSummaryReportTypeasaaasss = inputXMLDoc.CreateElement("ReportDateMacro");
                GeneralSummaryReportTypeasaaasss.InnerText = macro;
                AgingReportTypess.InnerText = "ARAgingSummary";
                AgingReportQueryRqs.SetAttribute("requestID", requestIdCounter.ToString());
                AgingReportQueryRqs.AppendChild(AgingReportTypess);
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement GeneralDetailReportQueryRsqs = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXMLMsgsRq.AppendChild(GeneralDetailReportQueryRsqs);

                XmlElement GeneralDetailReportTypsses = inputXMLDoc.CreateElement("GeneralSummaryReportType");
                GeneralDetailReportTypsses.InnerText = "InventoryStockStatusByItem";
                GeneralDetailReportQueryRsqs.AppendChild(GeneralDetailReportTypsses);

                XmlElement ReportDateMacrsoss = inputXMLDoc.CreateElement("ReportDateMacro");
                ReportDateMacrsoss.InnerText = macro;
                GeneralDetailReportQueryRsqs.AppendChild(ReportDateMacrsoss);

                GeneralDetailReportQueryRsqs.SetAttribute("requestID", requestIdCounter.ToString());
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement GeneralDetailReportQueryRqs = inputXMLDoc.CreateElement("GeneralDetailReportQueryRq");
                qbXMLMsgsRq.AppendChild(GeneralDetailReportQueryRqs);

                XmlElement GeneralDetailReportTypesa = inputXMLDoc.CreateElement("GeneralDetailReportType");
                GeneralDetailReportTypesa.InnerText = "Journal";
                GeneralDetailReportQueryRqs.AppendChild(GeneralDetailReportTypesa);

                XmlElement ReportDateMacrox = inputXMLDoc.CreateElement("ReportDateMacro");
                ReportDateMacrox.InnerText = macro;
                GeneralDetailReportQueryRqs.AppendChild(ReportDateMacrox);

                GeneralDetailReportQueryRqs.SetAttribute("requestID", requestIdCounter.ToString());
                requestIdCounter++;
    ...
    "LastQuarterToDate", "LastYear", "LastYearToDate"
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement GeneralSummaryReportQueryRqaaaas = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRqaaaas);
                XmlElement GeneralSummaryReportTypeaaaas = inputXMLDoc.CreateElement("GeneralSummaryReportType");
                XmlElement GeneralSummaryReportTypeaaaass = inputXMLDoc.CreateElement("ReportDateMacro");
                GeneralSummaryReportTypeaaaass.InnerText = macro;
                GeneralSummaryReportTypeaaaas.InnerText = "InventoryValuationSummary";
                GeneralSummaryReportQueryRqaaaas.SetAttribute("requestID", requestIdCounter.ToString());
                GeneralSummaryReportQueryRqaaaas.AppendChild(GeneralSummaryReportTypeaaaas);
    ...
    "LastQuarterToDate", "LastYear", "LastYearToDate"
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement GeneralSummaryReportQueryRaaqa = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRaaqa);
                XmlElement GeneralSummaryReportTypaaea = inputXMLDoc.CreateElement("GeneralSummaryReportType");
                GeneralSummaryReportTypaaea.InnerText = "ProfitAndLossByClass";
                
                XmlElement GeneralSummaryReportTypeaaaasss = inputXMLDoc.CreateElement("ReportDateMacro");
                GeneralSummaryReportTypeaaaasss.InnerText = macro;
                GeneralSummaryReportQueryRaaqa.SetAttribute("requestID", requestIdCounter.ToString());

                GeneralSummaryReportQueryRaaqa.AppendChild(GeneralSummaryReportTypaaea);
                requestIdCounter++;
    ...
    "LastQuarterToDate", "LastYear", "LastYearToDate"
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                // Create XML declaration and processing instruction
                inputXMLDoc.AppendChild(inputXMLDoc.CreateXmlDeclaration("1.0", "utf-8", null));
                inputXMLDoc.AppendChild(inputXMLDoc.CreateProcessingInstruction("qbxml", "version=\"16.0\""));

                // Create the QBXML and QBXMLMsgsRq elements
                 qbXML = inputXMLDoc.CreateElement("QBXML");
                inputXMLDoc.AppendChild(qbXML);
                ...
                XmlElement generalSummaryReportQueryRq = inputXMLDoc.CreateElement("GeneralDetailReportQueryRq");
                qbXMLMsgsRq.AppendChild(generalSummaryReportQueryRq);

                // Set the requestID and increment the counter
                generalSummaryReportQueryRq.SetAttribute("requestID", requestIdCounter.ToString());
                requestIdCounter++;

                // Create and append GeneralSummaryReportType element
                XmlElement generalSummaryReportType = inputXMLDoc.CreateElement("GeneralDetailReportType");
                generalSummaryReportType.InnerText = "ProfitAndLossDetail";
                generalSummaryReportQueryRq.AppendChild(generalSummaryReportType);

                // Create and append ReportDateMacro element
                XmlElement reportDateMacro = inputXMLDoc.CreateElement("ReportDateMacro");
                reportDateMacro.InnerText = macro;
                generalSummaryReportQueryRq.AppendChild(reportDateMacro);

                // Create and append AccountFilter element (for filtering by account type)
                XmlElement accountFilter = inputXMLDoc.CreateElement("ReportAccountFilter");
                generalSummaryReportQueryRq.AppendChild(accountFilter);

                XmlElement accountTypeFilter = inputXMLDoc.CreateElement("AccountTypeFilter");
                accountTypeFilter.InnerText = "ExpenseAndOtherExpense";  // You can adjust this as needed
                accountFilter.AppendChild(accountTypeFilter);

                // Convert the XML document to a string
                strRequestXML = inputXMLDoc.OuterXml;

                // Add the request XML to the request list
                req.Add(strRequestXML);
            }
    ...
    "LastQuarterToDate", "LastYear", "LastYearToDate"
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement GeneralDetailReportQueryRsq = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXMLMsgsRq.AppendChild(GeneralDetailReportQueryRsq);

                XmlElement GeneralDetailReportTypsse = inputXMLDoc.CreateElement("GeneralSummaryReportType");
                GeneralDetailReportTypsse.InnerText = "SalesByItemSummary";
                GeneralDetailReportQueryRsq.AppendChild(GeneralDetailReportTypsse);

                XmlElement ReportDateMacrsos = inputXMLDoc.CreateElement("ReportDateMacro");
                ReportDateMacrsos.InnerText = macro;
                GeneralDetailReportQueryRsq.AppendChild(ReportDateMacrsos);

                GeneralDetailReportQueryRsq.SetAttribute("requestID", requestIdCounter.ToString());
                requestIdCounter++;
            ...
            XmlElement GeneralSummaryReportQueryRqas = inputXMLDoc.CreateElement("GeneralSummaryReportQueryRq");
            qbXMLMsgsRq.AppendChild(GeneralSummaryReportQueryRqas);

            XmlElement GeneralSummaryReportTypeas = inputXMLDoc.CreateElement("GeneralSummaryReportType");
            GeneralSummaryReportTypeas.InnerText = "ProfitAndLossByClass";

            // Increment the requestIdCounter before setting the requestID attribute
            GeneralSummaryReportQueryRqas.SetAttribute("requestID", "9999");

            GeneralSummaryReportQueryRqas.AppendChild(GeneralSummaryReportTypeas);
            XmlElement GeneralSummaryReportsTypeaaaassss = inputXMLDoc.CreateElement("ReportDateMacro");
            GeneralSummaryReportsTypeaaaassss.InnerText = "Today";
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement profitAndLossByClassQueryRq = inputXmlDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXmlMsgsRq.AppendChild(profitAndLossByClassQueryRq);

                XmlElement reportType = inputXmlDoc.CreateElement("GeneralSummaryReportType");
                reportType.InnerText = "ProfitAndLossByClass"; // Changed to ProfitAndLossByClassSummary
                profitAndLossByClassQueryRq.AppendChild(reportType);

                XmlElement reportDateMacro = inputXmlDoc.CreateElement("ReportDateMacro");
                reportDateMacro.InnerText = macro;
                profitAndLossByClassQueryRq.AppendChild(reportDateMacro);

                profitAndLossByClassQueryRq.SetAttribute("requestID", requestIdCounter.ToString());
                requestIdCounter++;

                requestXml = inputXmlDoc.OuterXml;
            ...
            foreach (string macro in reportDateMacros)
            {
                ...
                XmlElement profitAndLossByClassQueryRqt = inputXmlDoc.CreateElement("GeneralSummaryReportQueryRq");
                qbXmlMsgsRq.AppendChild(profitAndLossByClassQueryRqt);

                XmlElement reportTypesss = inputXmlDoc.CreateElement("GeneralSummaryReportType");
                reportTypesss.InnerText = "IncomeByCustomerSummary"; // Changed to ProfitAndLossByClassSummary
                profitAndLossByClassQueryRqt.AppendChild(reportTypesss);

                XmlElement reportDateMascrosss = inputXmlDoc.CreateElement("ReportDateMacro");
                reportDateMascrosss.InnerText = macro;
                profitAndLossByClassQueryRqt.AppendChild(reportDateMascrosss);

                profitAndLossByClassQueryRqt.SetAttribute("requestID", requestIdCounter.ToString());
                requestIdCounter++;
